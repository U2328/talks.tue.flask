...
Revision ID: a302286f61b4
Revises: 
Create Date: 2019-04-14 19:46:42.807577
...
def upgrade():
    ...
    op.create_table('history_item',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('type', sa.Enum('MISC', 'CREATE', 'EDIT', 'DELETE', name='types'), nullable=True),
